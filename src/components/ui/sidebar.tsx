  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) shadow-[2px_0_16px_-10px_rgba(0,0,0,0.15)] transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
